    ...
    <section id="archive" className="w-full py-15">
      <div className="flex flex-col max-w-6xl px-4 mx-auto gap-10 w-fit items-start">
        <div className="flex flex-col gap-2 mx-auto">
          <h2 className="text-xl text-brand font-semibold text-center mx-auto">
            아카이브
          </h2>
        ...
        <a
          className="bg-background rounded-2xl cursor-pointer transform transition-transform duration-300 ease-in-out hover:scale-105 px-4 py-6 flex flex-col gap-5"
