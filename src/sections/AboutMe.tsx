  ...
  return (
    <section className="flex flex-col items-center gap-20 py-20 px-15">
      <div className="flex flex-col gap-2 items-center">
        <h3 className="text-brand font-semibold text-xl">핵심 역량</h3>
        <span className="text-lg text-center font-medium text-third whitespace-pre-wrap md:whitespace-normal">
          {`팀원과 같이 성장하는\n효율적인 개발을 합니다.`}
        </span>
      </div>
      <div className="flex flex-col lg:flex-row justify-center gap-10">
        <div className="flex flex-col gap-8 p-5">
          <h4 className="text-brand font-semibold text-lg sm:text-xl md:text-2xl text-center">
            프론트엔드 역량
          </h4>
          <p className="font-medium text-secondary text-sm sm:text-base whitespace-nowrap text-center p-5 bg-foreground rounded-xl">
